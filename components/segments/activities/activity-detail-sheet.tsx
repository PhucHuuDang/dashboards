      ...
      >
        <SheetHeader className="border-border bg-muted/30 border-b px-6 py-5">
          <div className="flex items-center justify-between gap-4 pr-6">
            ...
            <Badge
              variant="outline"
              className={cn("capitalize", STATUS_BADGE_CLASS[activity.status])}
            >
              {activity.status}
            </Badge>
          </div>
        ...
        <ScrollArea className="flex-1 px-6 py-6" id="activity-sheet-scroll">
          ...
          >
            ...
            {/* Assignee & Tags */}
            {(activity.assignee || activity.tags) && (
              <motion.div
            ...
            {activity.performance && (
              <motion.div variants={fadeUpVariant} className="mt-2 space-y-3">
                <h4 className="text-muted-foreground text-xs font-semibold uppercase tracking-wider">
                  Performance Insights
                </h4>
                <div className="grid grid-cols-2 gap-3">
                  {activity.performance.timeToComplete && (
                  ...
                  {activity.performance.impactScore !== undefined && (
                    <div className="bg-card border-border flex items-center gap-3 rounded-xl border p-3 shadow-sm">
                      <div className="bg-muted flex size-8 shrink-0 items-center justify-center rounded-lg">
                      ...
                      <div className="truncate">
                        ...
                        <p className="text-foreground truncate text-sm font-semibold">
                          {activity.performance.impactScore} / 100
                        </p>
                      </div>
                    </div>
                  )}
                  {activity.performance.linesOfCode !== undefined && (
                    <div className="bg-card border-border flex items-center gap-3 rounded-xl border p-3 shadow-sm">
                      <div className="bg-muted flex size-8 shrink-0 items-center justify-center rounded-lg">
                      ...
                      <div className="truncate">
                        ...
                        <p className="text-foreground text-sm font-semibold">
                          {activity.performance.linesOfCode}{" "}
